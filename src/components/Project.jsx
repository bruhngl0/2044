...
const projects = [
  {
    ...
    name: "e-comm",
    mobileBgImage: "party1.jpg",
    desktopBgImage: "party1.jpg", // Add desktop background image
  ...
  },
  {
    ...
    description:
      "Here is the new, light, and entertaining format of the series that we are excited to present to you format of the series that we are excited to",
    name: "e-comm",
    mobileBgImage: "party2.jpg",
    desktopBgImage: "party2.jpg", // Add desktop background image
    description1: "we live lit",
    description2: "test description two",
  },
  {
    ...
    description:
      "Here is the new, light, and entertaining format of the series that we are excited to present to you format of the series that we are excited to",
    name: "e-comm",
    mobileBgImage: "party3.webp",
    desktopBgImage: "party3.webp", // Add desktop background image
    description1: "we live lit",
    description2: "test description two",
